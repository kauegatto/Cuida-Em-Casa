export default function finalizarServicoAgora() {
    ...
    $.post("../../lib/libFinalizarServicoAgora.aspx", { diaAtual: dataAtual, horaFim: localStorage.getItem("horaFinal"), horaAtual: horaAtual, control: localStorage.getItem("controle")}, function (retorno)
    {
