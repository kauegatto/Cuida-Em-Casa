...
namespace prjCuidaEmCasa.classes.Agendamento
{
    public class clsServico : clsBanco_32623
    {
        ...
        public bool finalizarServicoAgora(string cdServico, string horaFim, string CEP, string cidade, string bairro, string rua, string num, string UF, string comp, string emailCliente, string cdPaciente, string vlMaximo, bool virarDia)
        {
            MySqlDataReader dados = null;
            string[,] valores = new string[14, 2];
            valores[0, 0] = "vCodigo";
            valores[0, 1] = cdServico;
            valores[1, 0] = "vHoraFimServico";
            valores[1, 1] = horaFim;
            valores[2, 0] = "vCEP";
            valores[2, 1] = CEP;
            valores[3, 0] = "vCidade";
            ...
            valores[8, 0] = "vComp";
            valores[8, 1] = comp;
            valores[9, 0] = "vEmailCliente";
            valores[9, 1] = emailCliente;
            valores[10, 0] = "vCodigoPaciente";
            valores[10, 1] = cdPaciente;
            valores[11, 0] = "vValorMaximo";
            valores[11, 1] = vlMaximo;
...
>>>>>>> b7de811f10d3f950bbce62560d26f4fb1cb82031
