...
export default function scriptAdicionarPaciente() {
	...
	async function processFile(){
	    ...
	    $.post("http://3.96.217.5/lib/libAdicionarPaciente.aspx",  { cdNecessidade: localStorage.getItem('necessidadeEscolhida'), imagemPaciente: imgPaciente, usuarioLogado : usuarioLogado,nome:nome, uf:uf, descricao: descricao, CEP:CEP, cidade : cidade,bairro: bairro,rua:rua, numero:numero, complemento:complemento  }, function (retorno) {
